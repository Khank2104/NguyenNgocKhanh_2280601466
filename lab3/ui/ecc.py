...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(926, 407)
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(320, 10, 71, 41))
        self.label.setObjectName("label")
        self.btn_gen_keys = QtWidgets.QLabel(Dialog)
        self.btn_gen_keys.setGeometry(QtCore.QRect(20, 120, 81, 31))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(20, 230, 61, 31))
        self.label_3.setObjectName("label_3")
        self.txt_info = QtWidgets.QTextEdit(Dialog)
        self.txt_info.setGeometry(QtCore.QRect(110, 100, 521, 87))
        self.txt_info.setObjectName("txt_info")
        self.txt_sign = QtWidgets.QTextEdit(Dialog)
        self.txt_sign.setGeometry(QtCore.QRect(110, 220, 521, 87))
        ...
        self.btn_sign.setGeometry(QtCore.QRect(200, 340, 93, 28))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(Dialog)
        self.btn_verify.setGeometry(QtCore.QRect(410, 340, 93, 28))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_gen_keys.setText(_translate("Dialog", "Information"))
